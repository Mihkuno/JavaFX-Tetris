...
public class Info implements MainInterface {
    ...
    public static void initObj() {
        ...
        link_font = Font.loadFont( Settings.class.getClassLoader().getResourceAsStream( "src/mikachan.ttf"), 14);
        ...
        btn_hub.setGraphic(new ImageView(new Image("src/GitHub-Mark-64px.png",28,28,true,true)) ); 
        ...
        btn_twt.setGraphic(new ImageView(new Image("src/twitter-circled-48.png",35,35,true,true)) ); 
    ...
    public static void initCase() {
        ...
        if (Settings.SHOWGRID) { INFO.setGridLinesVisible(true); }
    }
