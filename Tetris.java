...
public class Tetris implements MainInterface, TetrisInterface {
    ...
    public static void start() {
        ...
        // LOADING ANIMATION
        Image bg_anim = new Image("src/loading.gif");
            ...
            new Animate().start_swipe(panelContainer, 600, 500).setOnFinished((e) -> {
                ...
                DOCUMENT.setOnKeyPressed((key) -> {
                    if (key.getText().equals("w")) { 
                        ...
                        new Audio().playSound("fx_rotate.mp3");
                        focus.redrawActive();
                    }
                    if (key.getText().equals("d")) { 
                        ...
                        new Audio().playSound("fx_move.mp3");
                    }
    ...
    public static void updateHold() {
         ...
         if (holdContainer.getChildren().isEmpty()) {
             ...
             new Audio().playSound("fx_lock.mp3");
         }   
         ...
         if (hasSwitched == false) {
             ...
             new Audio().playSound("m_close.mp3");
    ...
    public static void generatePanel() {
        Font title_font = Font.loadFont( Tetris.class.getClassLoader().getResourceAsStream( "src/TrulyMadlyDpad-a72o.ttf"), 17);
        Font prev_font = Font.loadFont( Tetris.class.getClassLoader().getResourceAsStream( "src/TrulyMadlyDpad-a72o.ttf"), 15);
        Font val_font = Font.loadFont( Tetris.class.getClassLoader().getResourceAsStream( "src/TrulyMadlyDpad-a72o.ttf"), 13);
        ...
        btn_prev.setGraphic(new ImageView(new Image("src/ic_prev.png",28,28,true,true)) ); 
        ...
        btn_prev.setOnMousePressed((e) -> { 
            new Audio().playSound("m_click.mp3");
            pressed("prev");
        });
        ...
        btn_prev.setOnMouseEntered((e) -> {
            new Audio().playSound("m_hover.mp3");
    ...
    public static void hideGrid() {
        panelContainer.setGridLinesVisible(false);
        nextContainer.setGridLinesVisible(false);
        blockContainer.setGridLinesVisible(false);
        scoreContainer.setGridLinesVisible(false);
        titleContainer.setGridLinesVisible(false);
        holdContainer.setGridLinesVisible(false);
    }
    ...
    private static void pressed(String button) {
        if (button == "prev") {
            ...
            new Animate().start_fade(Menu.bg_menu).setOnFinished((e) -> {
                ...
                Menu.btn_info.setDisable(true);
                Menu.btn_start.setDisable(true);
                Menu.btn_setting.setDisable(true);
    ...
    public static void initGravity() {
        ...
        if (focus.isBottomPoked()) { 
            ...
            new Audio().playSound("fx_lnd01.mp3");
        } 
        else {
            focus.moveDown();
            delayGravity = false;        
    ...
    public static void validateLine() throws IndexOutOfBoundsException {
        ...
        */
        ...
        if (clearLine == true) {
            switch(COMBO) {
                case (0) : {new Audio().playSound("fx_lne01.mp3");   COMBO++; break;}
                case (1) : {new Audio().playSound("fx_lne02.mp3");  COMBO++; break;}
                case (2) : {new Audio().playSound("fx_lne03.mp3");  COMBO++; break;}
                default  : {new Audio().playSound("fx_lne04.mp3");  COMBO++; break;}
            }
            SCORE += ((3 * LEVEL) * COMBO);
