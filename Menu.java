...
public class Menu implements MainInterface {
    ...
    private void initObj() {
        // background image
        img_menu = new Image("src/bg_menu.png");
        ...
        // title text object
        title_font = Font.loadFont( Tetris.class.getClassLoader().getResourceAsStream("src/JoystickBold-62LA.ttf"), 140);
        title_text = new Text();
        title_text.setFont(title_font);
        title_text.setText("Tetris");

        // start button object
        btn_start_font = Font.loadFont( Tetris.class.getClassLoader().getResourceAsStream( "src/TrulyMadlyDpad-a72o.ttf"), 30);
        ...
        // settings button
        img_setting = new Image("src/ic_setting.png");
        ...
        // info button
        img_info = new Image("src/ic_info.png");
        btn_info = new Button();
        ...
        // background music
        new Audio().playMusic("bg_wires.mp3");
    }
